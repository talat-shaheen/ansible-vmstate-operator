...
# xyzcompany.com/ansible-vmstate-operator-bundle:$VERSION and xyzcompany.com/ansible-vmstate-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= xyzcompany.com/ansible-vmstate-operator
